...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 28.0, 90.0, 22.0 ],
					"text" : "loadmess 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 79.0, 29.5, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 117.0, 210.0, 36.0 ],
					"text" : "expr pow(pow($f1 - $f4\\, 2) + pow($f2 - $f5\\, 2) + pow($f3 - $f6\\, 2)\\, 0.5)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 168.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "point1 (list: x y z)",
					"cool" : 1,
					"id" : "obj-3",
					"index" : 2,
					"maxclass" : "inlet",
